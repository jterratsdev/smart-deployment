...
<!-- setup-agents:block:start id="codex-profile-security" version="3.16.0" -->
...
```bash
sf setup-agents review request --task <task> --reviewer <reviewer> --summary <summary>
...
sf setup-agents workflow gate --gate <gate> --run <run>   # --gate security
```
