...
<!-- setup-agents:block:start id="codex-profile-devops" version="2.0.2" -->
...
- After completing the review, always end with: _"Merge is ready pending your approval.
  Reply 'approve' or 'merge' to proceed, or let me know what to change."_
- If architectural scope was detected: _"Architect sign-off is required before merge.
  Tag @architect and share this review. Merge will proceed once they approve."_
