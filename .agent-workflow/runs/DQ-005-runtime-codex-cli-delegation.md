# Runtime Subagent Delegation Packet: DQ-005
...
Block deployment waves that would install Apex or CMDT dynamic-query consumers before required fields exist, and report actionable remediation.

## Subagent Assignments

### architect

- Ownership paths: src/waves, src/deployment, src/presentation, test/unit/waves, test/unit/deployment, test/unit/presentation
