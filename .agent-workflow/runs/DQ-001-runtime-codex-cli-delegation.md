# Runtime Subagent Delegation Packet: DQ-001
...
Extract high-confidence field references from dynamic SOQL embedded in Apex classes so deployment ordering can account for fields used only through runtime query strings.

## Subagent Assignments

### architect

- Ownership paths: src/parsers/apex-class-parser.ts, src/parsers/apex-class-dependencies.ts, src/parsers/apex-class-parser-model.ts, test/unit/parsers/apex-class-parser.test.ts
