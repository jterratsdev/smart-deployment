# Runtime Subagent Delegation Packet: US-RF-WAV-04
...
Refactor src/utils/cache-manager.ts by separating cache storage, serialization, TTL or eviction policy, cleanup, and lock lifecycle.

## Subagent Assignments

### architect

- Ownership paths: src/utils/cache-manager.ts, test/unit/utils/cache-manager.test.ts
