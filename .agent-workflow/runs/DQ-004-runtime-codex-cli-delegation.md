# Runtime Subagent Delegation Packet: DQ-004
...
Check unresolved dynamic-query field references against the target org before deployment when a target org is available.

## Subagent Assignments

### architect

- Ownership paths: src/deployment, src/commands/validate.ts, src/commands/start.ts, test/unit/deployment, test/unit/commands
