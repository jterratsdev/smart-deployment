# Runtime Child Prompt: SD-RC-RECONCILE
...
Apply still-relevant smart deployment, resume, deterministic Agentforce metadata, validation, and reporting changes onto current origin/main and validate a release candidate
...
- Load budget: normal
- Rationale: task text matches triggers: release, deploy
- Instructions:
...
- Write or summarize result evidence for .agent-workflow/handoffs/SD-RC-RECONCILE-wfrun-1788302052344-c60a10-developer-developer-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/SD-RC-RECONCILE-wfrun-1788302052344-c60a10-developer-developer-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session SD-RC-RECONCILE:wfrun-1788302052344-c60a10:developer:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/SD-RC-RECONCILE-wfrun-1788302052344-c60a10-developer-developer-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session SD-RC-RECONCILE:wfrun-1788302052344-c60a10:developer:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
