# Runtime Subagent Delegation Packet: NEXT-001
...
Validate start, validate, resume, and status against a realistic deployment harness so command behavior is proven beyond mocks and local-only state.

## Subagent Assignments

### architect

- Ownership paths: src/commands/start.ts, src/deployment, test/e2e, test/nut
