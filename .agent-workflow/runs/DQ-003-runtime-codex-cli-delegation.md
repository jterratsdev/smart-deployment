# Runtime Subagent Delegation Packet: DQ-003
...
Promote dynamic query field references into dependency graph edges so waves install referenced fields before Apex or CMDT consumers.

## Subagent Assignments

### architect

- Ownership paths: src/dependencies, src/services/scanners, test/unit/dependencies, test/unit/services
